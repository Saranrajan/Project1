...
text2, count = re.subn(r'LATEST_VERSION = 21|LATEST_VERSION = 23|LATEST_VERSION = 24|LATEST_VERSION = 25|LATEST_VERSION = 26|LATEST_VERSION = 27|LATEST_VERSION = 28|LATEST_VERSION = 29|LATEST_VERSION = 30|LATEST_VERSION = 31|LATEST_VERSION = 32', 'LATEST_VERSION = 33', text, count=1)
if count != 1:
